...
export const ACTIVITY: ProtocolEvent[] = [
  ...
  { kind: 'repayment', name: 'Repayment', detail: 'Loan #12 — principal', amount: '$45.00', time: '1h ago', age: 3_600 },
  { kind: 'score', name: 'Score update', detail: 'Milestone: 18 months history', amount: '+2 pts', time: '3h ago', age: 10_800 },
  { kind: 'deposit', name: 'Deposit', detail: 'General pool — 2.72% APY', amount: '$500.00', time: '1d ago', age: 86_400 },
  ...
  { kind: 'loan', name: 'Loan received', detail: 'General pool — 4.20% APR', amount: '$5,000', time: '5d ago', age: 432_000 },
  ...
  { kind: 'deposit', name: 'Deposit', detail: 'Bluechip pool — 4.10% APY', amount: '$1,250.00', time: '1w ago', age: 691_200 },
  ...
  { kind: 'deposit', name: 'Deposit', detail: 'General pool — 2.72% APY', amount: '$2,500.00', time: '1mo ago', age: 2_678_400 },
  { kind: 'loan', name: 'Loan received', detail: 'Sponsored pool — 3.80% APR', amount: '$5,000', time: '2mo ago', age: 5_184_000 },
];
